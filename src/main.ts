...
const questions = [
  ...
  'Gotten haircut by local GT barber',
  'Gotten into a scooter/skateboard accident',
  'Showed up to a lecture and immediately realized you were in the wrong class',
  'Camped on waitlist seats opening during registration',
  ...
  'Skipped more than 50% of classes consistently',
  ...
  'Paid $15 to get into Veranda just for a mid experience',
  'Took the Stinger drunk',
  'Failed to name a brother while trying to get into a frat party',
  ...
  'Taken a shower',
  'Cried over Brittain’s food quality',
  'Bragged about your internship on LinkedIn',
  'Pretended you\'ve never seen the question in your coding interview',
  ...
  'Thought Tech was gonna be like Big Bang Theory',
